...
class EditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edition" do
    assert_difference('Edition.count') do
      post editions_url, params: { edition: { description: @edition.description, month: @edition.month, number: @edition.number, publication: @edition.publication, volume: @edition.volume } }
    end
  ...
  test "should update edition" do
    patch edition_url(@edition), params: { edition: { description: @edition.description, month: @edition.month, number: @edition.number, publication: @edition.publication, volume: @edition.volume } }
